...
func TestWithdrawValidatorCommission(t *testing.T) {
	...
	valCommission := sdk.DecCoins{
		...
		sdk.NewDecCoinFromDec("ukii", sdk.NewDec(3).Quo(sdk.NewDec(2))),
	}
	...
	coins := sdk.NewCoins(sdk.NewCoin("mytoken", sdk.NewInt(2)), sdk.NewCoin("ukii", sdk.NewInt(2)))
	...
	expCoins := sdk.NewCoins(sdk.NewCoin("ukii", expTokens))
	...
	require.Equal(t, sdk.NewCoins(
		...
		sdk.NewCoin("ukii", expTokens.AddRaw(1)),
	), balance)
	...
	require.Equal(t, sdk.DecCoins{
		...
		sdk.NewDecCoinFromDec("ukii", sdk.NewDec(1).Quo(sdk.NewDec(2))),
	}, remainder)
...
func TestFundCommunityPool(t *testing.T) {
	...
	amount := sdk.NewCoins(sdk.NewInt64Coin("ukii", 100))
