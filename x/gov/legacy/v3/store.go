...
// If expedited, the deposit to enter voting period will be increased to 5000 ukii.
...
var (
	MinExpeditedDeposit   = sdk.NewCoins(sdk.NewCoin("ukii", types.DefaultMinExpeditedDepositTokens))
